...
export abstract class IMutation {
    ...
    abstract updateFileSource(id: string, input: UpdateFileSourceInput): FileSource | Promise<FileSource>;
    ...
    abstract updateWatchStatus(id: string, input: UpdateWatchStatusInput): WatchStatus | Promise<WatchStatus>;
    ...
    abstract createWatchProgress(input: CreateWatchProgressInput): WatchProgress | Promise<WatchProgress>;

    abstract updateWatchProgress(id: string, input: UpdateWatchProgressInput): WatchProgress | Promise<WatchProgress>;
